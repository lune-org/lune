...
impl CTypeCast for CType<f32> {
    fn cast(
        ...
        self.try_cast_num::<f32, u8>(into_ctype, from, into)?
            ...
            .or(self.try_cast_num::<f32, u128>(into_ctype, from, into)?)
            ...
            .or(self.try_cast_num::<f32, i128>(into_ctype, from, into)?)
            .or(self.try_cast_num::<f32, f32>(into_ctype, from, into)?)
            .or(self.try_cast_num::<f32, f64>(into_ctype, from, into)?)
            .or(self.try_cast_num::<f32, usize>(into_ctype, from, into)?)
            .or(self.try_cast_num::<f32, isize>(into_ctype, from, into)?)
