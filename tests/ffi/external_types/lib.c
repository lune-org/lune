...
int8_t ret_i8(void) { return -8; }
uint8_t ret_u8(void) { return 200; }
int16_t ret_i16(void) { return -1600; }
uint16_t ret_u16(void) { return 60000; }
int32_t ret_i32(void) { return -32000000; }
uint32_t ret_u32(void) { return 4000000000u; }
int64_t ret_i64(void) { return -9000000000LL; }
uint64_t ret_u64(void) { return 18000000000ULL; }
...
void write_byte(uint8_t *out, uint8_t value) { *out = value; }
...
int sum_triple(Triple t) { return t.v[0] + t.v[1] + t.v[2]; }
...
double sum_variadic_double(int count, ...) {
    va_list args;
    va_start(args, count);
    double total = 0;
    for (int i = 0; i < count; i++) {
